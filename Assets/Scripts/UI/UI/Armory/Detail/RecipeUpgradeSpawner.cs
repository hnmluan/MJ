...
public class RecipeUpgradeSpawner : Spawner
{
    ...
    {
        base.Awake();
        if (RecipeUpgradeSpawner.instance != null) Debug.Log("Only 1 UIArmoryItemSpawner allow to exist");
    ...
    {
        Transform uiWeapon = this.Spawn(RecipeUpgradeSpawner.recipeUpdateLevelUI, Vector3.zero, Quaternion.identity);
